...
public class OpenVpnApi {
    ...
    public static void startVpn(Context context, String inlineConfig, String sCountry,String expireAt , String userName, String pw,String connectRetry) throws RemoteException {
        if (TextUtils.isEmpty(inlineConfig)) throw new RemoteException("config is empty");
            startVpnInternal(context, inlineConfig, sCountry,expireAt, userName, pw,connectRetry);
    }

    static void startVpnInternal(Context context, String inlineConfig, String sCountry,String expireAt ,  String userName, String pw,String connectRetry) throws RemoteException {
        ...
        try {
            ...
            vp.mConnectRetry = connectRetry;
            vp.mConnectRetryMax = connectRetry;
